...
import 'package:flutter_cognito/screens/confirmation_screen.dart';
import 'package:flutter_cognito/screens/secure_counter_screen.dart';
import 'package:flutter_cognito/secrets.dart';
import 'package:flutter_cognito/user.dart';
import 'package:flutter_cognito/user_service.dart';
        ...
        onPressed: () async {
          if (_user.hasAccess) {
            ...
            if (!_user.confirmed) {
              ...
              await Navigator.push(context, MaterialPageRoute(builder: (context) => const SecureCounterScreen()));
            }
          }
        },
      ),
                      ...
                      children: <Widget>[
                        ListTile(
                          ...
                          title: TextFormField(
                            ...
                            decoration: const InputDecoration(hintText: 'example@inspire.my', labelText: 'Email'),
